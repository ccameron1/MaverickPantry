...
class ResourcesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func createAndAddResources(){
        ...
        let financialServices = ResourceItem(name: "Office of Financial Support and Scholarships", desc: "The Office of Financial Support and Scholarships is committed to giving UNO students as much information about costs and financial aid as possible. They also provide many tools and resources to help students achieve financial success. The office is located in room 103 of the Epply Admin Building.", image: UIImage(named: "UNOLogo")!, link: "https://www.unomaha.edu/admissions/financial-support-and-scholarships/index.php", phoneNumber: "(402)554-2327", address: "6001 University Dr N, Omaha, NE 68132")
